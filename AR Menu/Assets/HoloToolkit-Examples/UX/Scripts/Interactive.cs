...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    public class Interactive : MonoBehaviour, IInputClickHandler, IFocusable, IInputHandler
    {
        ...
        protected GameObject mainMenuGameObject;
        protected GameObject locationMenuGameObject;
        protected GameObject infoMenuGameObject;
        protected GameObject hintsMenuGameObject;
        protected GameObject vuforiaMenuGameObject;
        protected GameObject phoneMenuGameObject;
        protected GameObject videoMenuGameObject;
        protected GameObject manualMenuGameObject;
        protected GameObject manualOverviewMenuGameObject;
        protected GameObject[] GameObjectArray;
        ...
        protected void FindGameObjects()
        {
            mainMenuGameObject = GameObject.Find("MainMenu");
            locationMenuGameObject = GameObject.Find("LocationMenu");
            infoMenuGameObject = GameObject.Find("InfoMenu");
            hintsMenuGameObject = GameObject.Find("HintsMenu");
            vuforiaMenuGameObject = GameObject.Find("VuforiaMenu");
            phoneMenuGameObject = GameObject.Find("PhoneMenu");
            videoMenuGameObject = GameObject.Find("VideoMenu");
            manualMenuGameObject = GameObject.Find("ManualMenu");
            manualOverviewMenuGameObject = GameObject.Find("ManualOverviewMenu");
            GameObjectArray = new GameObject[] { mainMenuGameObject , locationMenuGameObject , infoMenuGameObject , hintsMenuGameObject , vuforiaMenuGameObject , phoneMenuGameObject , videoMenuGameObject , manualMenuGameObject , manualOverviewMenuGameObject };
        }

        protected void SelectGameObject(GameObject gameObject)
        {
            for (int i = 0; i < GameObjectArray.Length; i++)
            {
                if (gameObject == GameObjectArray[i])
                {
        ...
        protected void ChangeGameObject(InputClickedEventData eventData)
        {
            if (eventData.selectedObject.name == "MainMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "LocationMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "InfoMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "HintsMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "VuforiaMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "PhoneMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "VideoMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "ManualMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "ManualOverviewMenuButton")
            {
                SelectGameObject(selectGameObject);
            }
            else if (eventData.selectedObject.name == "BackButton")
            {
                SelectGameObject(selectGameObject);
            }
        }
